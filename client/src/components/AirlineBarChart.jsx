...
const categoryData = [
    { value: "least_delay", label: "Top 10 Airlines with Least Delay" },
    { value: "highest_delay", label: "Top 10 Airlines with Highest Delay" },
    { value: "most_cancelled", label: "Top 10 Airlines with Most Cancelled" },
    { value: "most_diverted", label: "Top 10 Airlines with Most Diverted" },
];
...
const AirlineBarChart = () => {
    ...
    const values = data && Array.isArray(data) ? data.map((items) => items.TOTAL_DELAY || items.DIVERTED || items.CANCELLED) : [];
        ...
        <div className="mt-24 w-full h-[100vh]">
            ...
            <form className="w-full flex justify-center">
                <div className="flex flex-col space-y-2">
                    ...
                    <select
                        id="category-select"
                        className="block w-76 border border-gray-300 rounded p-2"
